...
imgpath = '../data/ISIC2018/images'
txtsavepath = '../data/ISIC2018/'

imgtxt_1 = open('../data/ISIC2018/train.txt', 'w')
imgtxt_2 = open('../data/ISIC2018/val.txt', 'w')
imgtxt_3 = open('../data/ISIC2018/test.txt', 'w')
