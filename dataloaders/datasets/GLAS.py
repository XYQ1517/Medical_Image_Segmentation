...
class Segmentation(Dataset):
    ...
    def __init__(self,
        ...
        for splt in self.split:
            if splt == "train" or splt == "val":
                self._image_dir = os.path.join(self._base_dir, "train", 'images')
                self._cat_dir = os.path.join(self._base_dir, "train", 'masks')
            if splt == "test":
            ...
            for ii, line in enumerate(lines):
                _image = os.path.join(self._image_dir, line + '.bmp')
                _cat = os.path.join(self._cat_dir, line + '_anno.bmp')
