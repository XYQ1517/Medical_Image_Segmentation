...
class WNet2D(nn.Module):
    def __init__(self, in_channel=3, num_classes=1, deep_supervised=False, layer_channel=[16, 32, 64, 128, 256], global_dim=[8, 16, 32, 64, 128], num_heads=[1, 2, 4, 8], sr_ratio=[8, 4, 2, 1]):
