...
class EMCADNet(nn.Module):
    def __init__(self, num_classes=1, kernel_sizes=[1,3,5], expansion_factor=2, 
                 dw_parallel=True, add=True, lgag_ks=3, activation='relu', encoder='pvt_v2_b2', pretrain=True):
        ...
        if encoder == 'pvt_v2_b0':
            ...
            path = '/home/wpf/SSD/XYQ/medical_image_segmentation/modeling/pvt_v2_b0.pth'
