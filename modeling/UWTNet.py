...
class UWTNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=1, wave_level=2, model_size='mid'):
        ...
        self.final_conv = nn.Conv2d(num_channels[0], num_classes, kernel_size=1)
