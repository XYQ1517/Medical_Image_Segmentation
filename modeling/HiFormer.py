...
def get_hiformer_b_configs():
    ...
    #     print('Downloading Swin-transformer model ...')
    #     wget.download("https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_tiny_patch4_window7_224.pth", "./weights/swin_tiny_patch4_window7_224.pth")    
    cfg.swin_pretrained_path = '/home/wpf/SSD/XYQ/medical_image_segmentation/modeling/swin_tiny_patch4_window7_224.pth'
...
class HiFormer(nn.Module):
    def __init__(self, config=get_hiformer_b_configs(), img_size=224, in_chans=3, num_classes=9):
        super().__init__()
