...
from .CASCADE_Decoder import CASCADE
from .CASCADE_backbone import Transformer, SegmentationHead, get_r50_b16_config
...
class PVT_CASCADE(nn.Module):
    def __init__(self, num_classes=1):
        ...
        path = '/home/wpf/SSD/XYQ/medical_image_segmentation/modeling/pvt_v2_b2.pth'
    ...
    def forward(self, x):
        ...
        return torch.sigmoid(p1+p2+p3+p4)
