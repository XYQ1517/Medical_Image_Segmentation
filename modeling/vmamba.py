...
@register_model
def vmamba_tiny_s1l8(pretrained=None, channel_first=True, **kwargs):
    model = Backbone_VSSM(pretrained=pretrained,
    ...
    #     model.load_state_dict(load_checkpoint(pretrained))
    return model


@register_model
def vmamba_small_s2l15(pretrained=None, channel_first=True, **kwargs):
    model = Backbone_VSSM(pretrained=pretrained,
...
@register_model
def vmamba_base_s2l15(pretrained=None, channel_first=True, **kwargs):
    model = Backbone_VSSM(pretrained=pretrained,
...
if __name__ == '__main__':
    ...
    model = vmamba_base_s2l15().to("cuda:0")
    y = model(x)
    print(y.shape)
