...
from modeling.resnet import resnet50  # Fix import to match package path when running from project root.
...
class ConDSeg(nn.Module):
    def __init__(self, num_classes=1, H=256, W=256):
        super().__init__()
        ...
        """ Output Block """
        self.output_block = output_block(128, num_classes)
